{
  ...
  "workBenchVersionFileCreation": "6.4.2",
  "hardwares": {
    "type": "INVERTER",
    "control": {
          ...
          "hwVariants": [
            {
              ...
              "signals": {
                "PWM_ESC_INPUT": [
                  {
                    "name": "PA15",
                    "help": "Check if Timer is not already used.",
                    "cost": 10
                  }
                ]
              },
              "help": {
                "en": [
                  "Check if Timer is not already used."
                ]
              },
              "cost": 10
            }
      ...
      "link": "https://www.st.com/en/evaluation-tools/b-g431b-esc1.html"
    },
    "motor": [
      {
        "polePairs": 2,
        "id": "motorLowVoltage-I",
        "label": "I-PMSM 24V motor",
  ...
  "details": {
    "steps": {
      ...
      "applicationConfig": {
        ...
        "lowMemoryFootprintReg": false,
        "motorProfiler": false,
        "dbgMcuLoadMeasure": true
      },
      "speedSensingSel_0": {
        "mainSensorParams": {
      ...
      "speedSensing_0": {
        "mainSensorParams": {
          ...
          "sensorParams": {
            ...
            "startUpParam": {
              "duration": 2000,
              "electricalAlignAngle": 90,
              "finalCurrent": 3
            }
          }
        },
        "auxSensorParams": {
          "enableAuxSensing": true,
          "speedSensorMode": "pll",
          "maxAllowedErrors": "Number.NaN",
          "sensorParams": {
            "_tag": "pll",
